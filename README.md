# ia-resolving-questions
A website for resolving questions using decision trees to build dashboards and for use in a gamified chatbot.

To use the system, assign the following commands in Python Django:
